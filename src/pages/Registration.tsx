...
const Registration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const totalTeamSize = allMembers.length;

      // Step 1: Create team (using new schema with user_id and phone_number)
      ...
      // Step 2: Add all team members (including leader)
      ...
      // Step 4: Save registration details (extended personal info)
